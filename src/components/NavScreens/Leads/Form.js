...
const Form = () => {  const navigate = useNavigate()
    ...
    const handleSubmit = e => {
        ...
        axios.post('/leads', {firstName, lastName, address, city, state, zipcode, email, phone, useage})
        .then(() => {
            navigate('/leads')
        })
        ...
        <Container>
            <form className="form add-lead-form" onSubmit={handleSubmit}>
               ...
               <input 
                ...
                <button onClick={() => {navigate('/dashboard')}} className="form-back-btn">GO BACK</button>
